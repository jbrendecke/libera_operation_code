...
def parse_cli_args():
    ...
    parser = argparse.ArgumentParser(
        prog="libera-l2-sw-clac-algorithm",
        description="Libera SW-Calc using ERA5 and SSF properties. Calculates fluxes \
            for every footprint over an entire day."
    )
...
def read_manifest(input_manifest):
    #//////////////////////////////////////
    # uses output of  Manifest.from_file input manifest json file
...
def L2_calc_main(input_manifest_path): 
#    input_manifest_path = '/home/jbrendecke/L2/data/LIBERA_INPUT_MANIFEST_01KB0X2N9JXA2VGEXG1PZXJQV2.json' 
    ...
    iyr = int(str(time_st)[:4])
    imon = int(str(time_st)[5:7])
    iday = int(str(time_st)[8:10])
    ...
    output_dict ={
        ...
        'longitude' : lon_ssf,
        'latitude' :  lat_ssf,
        'SWD_TOA_VIS': swd_toa_vis,
        'SWD_TOA_NIR': swd_toa_nir,
        'SWU_TOA_VIS_ALL': swu_toa_all_vis,
        'SWU_TOA_NIR_ALL': swu_toa_all_nir,
        'SWU_TOA_VIS_CLR': swu_toa_clr_vis,
        'SWU_TOA_NIR_CLR': swu_toa_clr_nir,
        'SWD_SFC_VIS_ALL': swd_sfc_all_vis,
        'SWD_SFC_NIR_ALL': swd_sfc_all_nir,
        'SWD_SFC_VIS_CLR': swd_sfc_clr_vis,
        'SWD_SFC_NIR_CLR': swd_sfc_clr_nir,
        'SWU_SFC_VIS_ALL': swu_sfc_all_vis,
        'SWU_SFC_NIR_ALL': swu_sfc_all_nir,
        'SWU_SFC_VIS_CLR': swu_sfc_clr_vis,
        'SWU_SFC_NIR_CLR': swu_sfc_clr_nir,
        'DIRECT_SFC_ALL':  direct_sfc_all,
        'DIFFUSE_SFC_ALL': diffuse_sfc_all,
...
# currently the only day to run is 20180322
# if not using argparse
#input_manifest_path = '/home/jbrendecke/L2/data/LIBERA_INPUT_MANIFEST_01KB0X2N9JXA2VGEXG1PZXJQV2.json'
